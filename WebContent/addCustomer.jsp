...
<%
    ...
    //Check it all the fields have values
    if (username == null || password == null || firstName == null || lastName == null || email == null ||
        ...
        response.sendRedirect("admin.jsp?error=empty"); // Redirect with an error message
    } else {
        try {
            getConnection();
            ...
            //Check if user exists. If so, redirect with error
            if (rst.next()) {
                response.sendRedirect("admin.jsp?error=exists"); // Redirect with an error message
            } else {
                ...
                if (rowsAffected > 0) {
                    ...
                    if (generatedKeys.next()) {
                        ...
                        response.sendRedirect("admin.jsp?registration=success");
                    }
                }
